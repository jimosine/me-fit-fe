    ...
    <>
      <Card style={{ width: '18rem' }}>
        ...
        <Card.Body>
          ...
          <Card.Text>Very good training by a very good trainer</Card.Text>
            ...
            >
              ...
              <Modal.Body>
                <div style={{ display: 'flex' }}>
                  ...
                  <div style={{ width: '50%' }}>
                    <p>
                      <h4>Muscle group:</h4> Muscle Group Name
                    </p>
                    <p>
                      <h4>Description:</h4> Je moet eerst duwen, dan trekken,
                      dan op je hoofd staan. Draai dan 10 rondjes
                    </p>

                    <p>
                      <h4>Repetitions:</h4> 10
                    </p>
                    <div>
                      <ReactPlayer
            ...
            >
              ...
              <Modal.Body>
                <div style={{ display: 'flex' }}>
                  ...
                  <div style={{ width: '50%' }}>
                    <p>
                      <h4>Type:</h4> Spartan Warrior Program
                    </p>
                    <p>
                      <h4>Workouts:</h4>
                      <ul>
